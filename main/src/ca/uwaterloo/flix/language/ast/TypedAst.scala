...
object TypedAst {
  ...
  object Expression {
    ...
    case class ArrayNew(elm: TypedAst.Expression, len: Int, tpe: Type, eff: ast.Eff, loc: SourceLocation) extends TypedAst.Expression
  ...
  case class SelectRule(pat: TypedAst.Pattern, chan: TypedAst.Expression, exp: TypedAst.Expression) extends TypedAst
