...
object ResolvedAst {
  ...
  object Expression {
    ...
    case class NewChannel(exp: ResolvedAst.Expression, tvar: Type.Var, loc: SourceLocation) extends ResolvedAst.Expression
  ...
  case class SelectRule(pat: ResolvedAst.Pattern, exp1: ResolvedAst.Expression, exp2: ResolvedAst.Expression) extends ResolvedAst
