...
object WeededAst {
  ...
  object Expression {
    ...
    case class Spawn(lambda: WeededAst.Expression, loc: SourceLocation) extends WeededAst.Expression
  ...
  case class SelectRule(pat: WeededAst.Pattern, exp1: WeededAst.Expression, exp2: WeededAst.Expression) extends WeededAst
}
