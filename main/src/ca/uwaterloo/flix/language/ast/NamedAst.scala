...
object NamedAst {
  ...
  object Expression {
    ...
    case class NewChannel(exp: NamedAst.Expression, tvar: ast.Type.Var, loc: SourceLocation) extends NamedAst.Expression
  ...
  case class SelectRule(pat: NamedAst.Pattern, exp1: NamedAst.Expression, exp2: NamedAst.Expression) extends NamedAst
