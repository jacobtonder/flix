...
import java.util.concurrent.{BlockingQueue, ConcurrentLinkedQueue, locks}
...
object Value {
  ...
  case class Channel(queue: BlockingQueue[AnyRef], locks: ConcurrentHashMap[Lock]) extends  Value {
