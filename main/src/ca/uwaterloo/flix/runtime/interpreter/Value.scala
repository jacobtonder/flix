...
object Value {
  ...
  case class Channel(queue: util.Queue[AnyRef], capacity: Int, aLock: Lock, bufferNotFull: Condition, bufferNotEmpty: Condition, conditions: ListBuffer[(Lock, Condition)]) extends Value {
